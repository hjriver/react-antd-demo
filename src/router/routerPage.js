...
// import RouteList from './modules/list'

// import comp from './modules/component'
...
//
// const Home = LoadableComponent(()=>import('../page/home'))  //参数一定要是函数，否则不会懒加载，只会代码拆分
//
// //基本组件Demo
// const Tabble = LoadableComponent(()=>import('../page/tabble'))
// const Users = LoadableComponent(()=>import('../page/users'))


import PrivateRoute from '../components/PrivateRoute'

import Home from '../page/home'  //参数一定要是函数，否则不会懒加载，只会代码拆分
  ...
  render () {
    return (
      <div style={{padding: 16, position: 'relative'}}>
        ...
        <Route exact path='/home/tabble' component={Tabble}/>
...
{/*
          ...
          <Redirect exact from='/' to='/home/tabble'/>
        <Redirect exact from='/home' to='/home/tabble'/>
        </Switch>
      </div>
    )
  }
